...
<LINK href="styles/css1.css" type=text/css rel=stylesheet>
<LINK href="styles/newhead.css" type=text/css rel=stylesheet>
...
<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0>
  ...
  <TR>
    ...
    <TD><INPUT title=登录后台 type=image height=48 alt="" width=86 
      src="images/crm_17.gif" onClick="checkLogin();"></TD>
    <TD><IMG height=48 alt="" src="images/crm_18.gif" width=21></TD>
    <TD colSpan=2><IMG title=返回首页 height=48 alt="" src="images/crm_19.gif" width=84 
      border=0 onClick="reset();" style="cursor:pointer"></TD>
